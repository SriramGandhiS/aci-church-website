          ...
          <div className="about-left">
            ...
            {isTa ? (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', color: 'var(--color-text-mid)', lineHeight: '1.8', fontSize: '15px' }}>
                <p>
                  <strong>பேராயர் பேரருட்திரு ச. ஜான்சன் துரை</strong> — தேவனால் தெரிந்துகொள்ளப்பட்ட பாத்திரமும், பிரதிஷ்டை செய்யப்பட்ட ஊழியரும், அப்போஸ்தலரும், வேத போதகருமாகிய இவர், சர்வவல்ல தேவனுக்கு <strong>35 ஆண்டுகளுக்கும் மேலாக</strong> ஊழியஞ் செய்து வருகிறார்.
                </p>
                <p>
