      ...
      <div className="auth-modal-card" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="auth-modal-header">
          ...
          <p className="auth-modal-subtitle">
            {isTa
              ? 'விண்ணப்பத்தை தொடங்க உங்கள் மின்னஞ்சல் மற்றும் கடவுச்சொல் மூலம் உள்நுழையவும்.'
              : 'Enter your email and password or continue with Google to access your application.'}
          </p>
        </div>
        ...
        <div className="auth-modal-body">
          ...
          {/* 1. TOP: Standard Email & Password Form */}
